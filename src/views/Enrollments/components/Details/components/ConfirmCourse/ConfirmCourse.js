    ...
    <Typography>
      ...
      <div>
        <table className="table">
          <thead>
            <tr>
              <th className={classes.tableHeader} scope="col">Class No.</th>
              ...
              <th className={classes.tableHeader} scope="col">Room</th>
              <th className={classes.tableHeader} scope="col">Status</th>
            </tr>
          </thead>
          <tbody>
            <tr>
